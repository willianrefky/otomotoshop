...
<body>
	...
	<header>
		...
		<div id="top-header">
			<div class="container">
				<div class="pull-left">
					<span><a href="#">WA/SMS : 089XXXXXXX</a></span> &nbsp; &nbsp; | &nbsp; &nbsp;
					<span><a href="#">Otomotoshop@gmail.com</a></span>
				</div>
				<div class="pull-right">
					<ul class="header-top-links">
						<li><a href="#">LOGIN </a></li> &nbsp; &nbsp;|
						<li class="dropdown default-dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">BANTUAN <i class="fa fa-caret-down"></i></a>
			...
			<div class="container">
				<div class="pull-left">
					...
					<div class="header-logo">
						<h1><a class="logo" href="#">Otomotoshop
                                                </a></h1>
					</div>
					<!-- /Logo -->
					...
					<div class="header-search">
						<form>
							<input class="input search-input" type="text" placeholder="Cari yang anda inginkan ...">
							<select class="input search-categories">
								<option value="0">Semua Kategori</option>
								<option value="1">Kategory 01</option>
								<option value="1">Kategory 02</option>
							</select>
			...
			<div id="responsive-nav">
				...
				<div class="menu-nav">
					...
					<ul class="menu-list">
						...
						<li class="dropdown default-dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Produk <i class="fa fa-caret-down"></i></a>
							<ul class="custom-menu">
								<li><a href="products.html">Produk</a></li>
								<li><a href="product-page.html">Detail Produk</a></li>
						...
						<li>
              				<a class="nav-link js-scroll-trigger" href="#footer">Tentang Kami</a>
            			</li>
					</ul>
				</div>
				<!-- menu nav -->
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="footer">
						...
						<div class="footer-logo">
							<a class="logo" href="#">
		            <img src="./img/Logo1.jpg" width="200px" alt="">
		          </a>
						</div>
						<!-- /footer logo -->
